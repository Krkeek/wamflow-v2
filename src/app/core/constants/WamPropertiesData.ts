...
export const dummyApplication: CellDataDto = {
  ...
  props: {
    ...
    maxUsers: { label: 'Max Users', type: DataTypes.number, value: 100, required: true, max: 200 },
...
export const dummySecurityRealm: CellDataDto = {
  ...
  props: {
    ...
    authMethod: {
      ...
      type: DataTypes.enum,
      value: 'password',
      options: ['password', 'token', 'certificate'],
    },
